...
----
[start=4]
. Create a new repository to host the mirror, using the web interface. In the following example I am using "ocp"
...
mkdir ~/vccerts
cd ~/vccerts
wget https://vcsa.pietersmalan.com/certs/download.zip
